...
namespace app {
    void AppWifi::init(OnWifiConnected_f conn, OnWifiDisconnected_f disc) {
        m_connected = conn;
        m_disconnected = disc;
    ...
    void AppWifi::handleWifiEvent(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data) {
